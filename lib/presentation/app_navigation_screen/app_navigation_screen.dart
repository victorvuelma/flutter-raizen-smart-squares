...
class AppNavigationScreen extends GetWidget<AppNavigationController> {
  ...
  onTapTeste() {
    Get.toNamed(AppRoutes.testeScreen);
  }
  ...
  onTapTelaPrincipalOne() {
    Get.toNamed(AppRoutes.telaPrincipalOneScreen);
  }
  ...
  onTapApresentaoAppTwo() {
    Get.toNamed(AppRoutes.apresentaOAppTwoScreen);
  }

  onTapApresentaoAppThree() {
    Get.toNamed(AppRoutes.apresentaOAppThreeScreen);
  }
}
