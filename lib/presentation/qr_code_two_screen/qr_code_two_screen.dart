...
class QrCodeTwoScreen extends GetWidget<QrCodeTwoController> {
  @override
                          ...
                          child: Container(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                        padding: getPadding(
                                            left: 41, top: 43, right: 41),
                                        child: ImageView(
                                            imagePath: AssetConstant.imgImage12,
                                            height: getVerticalSize(200.00),
                                            width: getHorizontalSize(236.00))),
                                    Container(
                                        width: getHorizontalSize(275.00),
                                        margin: getMargin(
                                            left: 41, top: 65, right: 41),
                                        child: Text("msg_aponte_a_c_mera".tr,
                                            maxLines: null,
                                            textAlign: TextAlign.center,
